...
- If the first two dimensions of the output does not give the best visualization for your purpose, similar to PCA you may try a few other dimensions, and a linear rotation of the output may give better visualization for what you are interested in. You can for example find a rotation that best separate your clusters in a supervised manner using 'sklearn.discriminant_analysis.LinearDiscriminantAnalysis'.
